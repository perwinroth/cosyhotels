    ...
    <div>
      <header style={{ marginBottom: 18 }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 13.5, marginTop: 5 }}>
          Parsed from PR digests, triaged for fit, and drafted in Gmail where GotCosy has something real to add. Every draft is Per&apos;s to edit and send — nothing here sends itself.
        </p>
      </header>
