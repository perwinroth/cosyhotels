...
export function GET(req: Request) {
  ...
  for (const p of ["/sitemap.xml", "/sitemap-hotels.xml", "/sitemap-cities.xml", "/sitemap-collections.xml", "/sitemap-static.xml", "/sitemap-blog.xml", "/sitemap-trips.xml", "/sitemap-lists.xml"]) revalidatePath(p);
