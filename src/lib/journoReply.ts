...
- BANNED (these read as AI/PR sludge and get the email deleted): "I hope this finds you well", compliment openers, "delve/pivotal/underscore/testament", "not just X but Y" constructions, three-item rhythm ("X, Y, and Z" everywhere), uniform paragraph lengths, any sentence that sounds like a press release. NEVER use an em dash (—) anywhere in the email; rewrite with a colon, comma, or two sentences.
- Sign off exactly: "Per" on one line, then "gotcosy.com" on the next line.
