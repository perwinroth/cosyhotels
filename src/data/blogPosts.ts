...
export const BLOG_POSTS: BlogPost[] = [
    ...
    intro: [
      ...
      },
      {
        ...
        paras: [
          ...
          "The inverse matters too. Twenty reviews that only ever say the staff were friendly — no names, no specifics — usually describe a place where service is a rota, not a relationship. Friendly is trainable. Being named is earned.",
        ],
      },
      {
  ...
  // ── 11. ONE NIGHT (top-of-funnel, advice-only) ─────────────────────────────────────────────
  {
    ...
    intro: [
      ...
      {
        h2: "Do the check-in maths — small hotels especially",
        paras: [
  ...
  // ── 12. LIGHT SLEEPERS ─────────────────────────────────────────────────────────────────────
  {
    ...
    lead: "If you're a light sleeper, you already know the pattern: the lovely hotel, the charming street — and the 2am delivery van, the bar crowd, the corridor door that slams. The fix isn't a quieter city; every city is loud somewhere and silent two streets away. A good night is three decisions made before you book: choose the street, choose the building, then claim the right side of it. None of this needs luck, and most of it is visible in the map and the reviews. Here's the method.",
    updated: "2026-07-08",
    intro: [
      {
    ...
    outro: [
      {
        ...
        paras: [
          "Everything above rests on guest-reported quiet: what people wrote after sleeping there. Nobody — not us, not any booking site — measures hotel noise, so treat every quiet claim, including ours, as testimony rather than measurement. That's also why we won't rank cities for quiet: the data doesn't exist, and the street you're on matters more than the city anyway.",
