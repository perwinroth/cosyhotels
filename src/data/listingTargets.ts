...
export const LISTING_TARGETS: ListingTarget[] = [
  ...
  { id: "startupbase", name: "StartupBase", submitUrl: "https://startupbase.io/submit", tier: 2, dr: null, cost: "free", dofollow: null, effort: "10min", fields: "name, tagline, description, category, URL", note: "Also a card on the PR board (tick both)." },
  ...
  { id: "toolify", name: "Toolify.ai", submitUrl: "https://www.toolify.ai/submit", tier: 3, dr: 74, cost: "freemium", dofollow: true, effort: "15min", fields: "tool name, URL, category, description, logo, screenshots", note: "Also a card on the PR board (tick both). Free queue takes 2-4 weeks; do not pay the express fee." },
